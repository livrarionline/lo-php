<?php
	...
	// 										PLUS EXPECTED IN									//
	//////////////////////////////////////////////////////////////////////////////////////////////
	$lo->plus_expectedin(42, '10002222'); // 42 - dulapid, '10002222' - orderid
	//////////////////////////////////////////////////////////////////////////////////////////////
	// 									  END PLUS EXPECTED IN									//
	//////////////////////////////////////////////////////////////////////////////////////////////

	//////////////////////////////////////////////////////////////////////////////////////////////
	// 										GET RESERVATION ID									//
	//////////////////////////////////////////////////////////////////////////////////////////////
	$reservation = $lo->get_reservationid(42, 3, '10002222'); // 42 - dulapid, 3 - cellsize (1 -> L (440mm / 600mm / 611mm), 2 -> M (498mm / 600mm / 382mm), 3 -> S (498mm / 600mm / 300mm), 4 -> XL (600mm / 600mm / 600mm)) '10002222' - orderid;
